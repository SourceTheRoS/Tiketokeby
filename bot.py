...
START_BUTTONS=[
    [
        InlineKeyboardButton('المطور', url='https://t.me/vOvvvvv'),
        InlineKeyboardButton('المطور²', url='https://t.me/JaJJJJ'),
        InlineKeyboardButton('قناة السورس', url='https://t.me/nnn_e'),
    ],]
...
vOvvvvv = Client('TikTok', api_id=APP_ID, api_hash=API_HASH, bot_token=BOT_TOKEN)
...
@vOvvvvv.on_message(filters.command('start') & filters.private)
...
@vOvvvvv.on_message(filters.regex(pattern='.*http.*') & filters.private)
